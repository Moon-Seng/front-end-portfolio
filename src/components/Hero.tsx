...
export function Hero() {
  ...
  return (
    <section
      id="home"
      ref={heroRef}
      className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950 overflow-hidden px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24"
    >
      ...
      <div className="relative z-10 max-w-4xl 2xl:max-w-6xl mx-auto text-center space-y-6 sm:space-y-8 lg:space-y-12">
        <h1 ref={titleRef} className="font-bold leading-tight">
          ...
          <span className="block bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-500 bg-clip-text text-transparent text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-7xl 2xl:text-8xl font-black w-full leading-[1.05]">
            {hero.title}
          </span>
        </h1>
